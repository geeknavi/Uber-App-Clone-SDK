...
- (void)presentationTransitionWillBegin {
    ...
    [transitionCoordinator animateAlongsideTransition:^(id<UIViewControllerTransitionCoordinatorContext> context) {
        self.backgroundDimmingView.alpha = 0.5f;
    }
                                           completion:nil];
}
...
+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message mainThemeColor:(UIColor *)mainThemeColor subThemeColor:(UIColor *)subThemeColor textColor:(UIColor *)textColor{
    ...
    alertController.swipeDismissalGestureEnabled = YES;
    
    alertController.buttonCornerRadius = 10.0f;
    
    alertController.titleFont = [UIFont fontWithName:@"AvenirNext-Bold" size:18.0f];
    alertController.messageFont = [UIFont fontWithName:@"AvenirNext-Medium" size:16.0f];
    alertController.buttonTitleFont = [UIFont fontWithName:@"AvenirNext-Regular" size:alertController.buttonTitleFont.pointSize];
    alertController.cancelButtonTitleFont = [UIFont fontWithName:@"AvenirNext-Medium" size:alertController.cancelButtonTitleFont.pointSize];
    
    alertController.alertViewBackgroundColor = mainThemeColor;
    alertController.alertViewCornerRadius = 10.0f;
    
    alertController.titleColor = subThemeColor;
    alertController.messageColor = textColor;
    
    alertController.buttonColor = subThemeColor;
    alertController.buttonTitleColor = mainThemeColor;
    
    alertController.cancelButtonColor = subThemeColor;
    alertController.cancelButtonTitleColor = mainThemeColor;
...
- (void)panGestureRecognized:(UIPanGestureRecognizer *)gestureRecognizer {
    ...
    presentationController.backgroundDimmingView.alpha = 0.5f - (fabs([gestureRecognizer translationInView:self.view].y) / windowHeight);
            ...
            [UIView animateWithDuration:0.5f
                 ...
                 usingSpringWithDamping:0.8f
                  initialSpringVelocity:0.4f
                                options:0
                             animations:^{
                                 presentationController.backgroundDimmingView.alpha = 0.5f;
                                 [self.view layoutIfNeeded];
                             }
                             completion:nil];
        }
