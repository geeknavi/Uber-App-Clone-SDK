...
typedef BOOL(^GeekNaviStarRatingViewShouldBeginGestureRecognizerBlock)(UIGestureRecognizer *gestureRecognizer);

@interface GeekNaviStarRatingView : UIControl
...
@property (nonatomic, copy) GeekNaviStarRatingViewShouldBeginGestureRecognizerBlock shouldBeginGestureRecognizerBlock;
